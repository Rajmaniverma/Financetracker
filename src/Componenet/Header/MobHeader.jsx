...
>
      ...
      <div className=" sm:space-x-3 space-x-1">
        {/* ADD income  */}
<button className="btn-income text-white text-[14px] sm:px-3 px-1 py-1.5 font-semibold  mr-2 rounded-md  transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-105 hover:shadow-[0_0_45px_rgba(0,200,0,0.9)] active:translate-y-0 active:scale-95 cursor-pointer"   onClick={() => {
    setshow(true);
...
{/* Add expenses */}
<button className=" btn-expense text-white  sm:px-3 px-1 text-[13px] py-1.5 font-semibold  mr-2 rounded-md   transition-all duration-300 ease-out hover:-translate-y-1 hover:scale-105  active:translate-y-0 active:scale-95 cursor-pointer"
  onClick={() => {
    setShowExpense(true);
